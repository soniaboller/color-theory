...
function ColorStorer(clickedColor, nextBoxColor, previousBoxColor){
    this.clickedColor = clickedColor;
    this.nextBoxColor = nextBoxColor;
    this.previousBoxColor = previousBoxColor;
    this.rgbToArray = function(){
        var colorArray = [];
...
$('#start').on('click', function(){
    ...
    $('.box').on('click', function(){
        ...
        var nextBoxColor = nextBox.css('backgroundColor');
        var previousBoxColor = previousBox.css('backgroundColor');
        console.log('this is the next box id '+ nextBox[0].id);
        console.log('this is the next box color '+ nextBoxColor);
        // rgbToArray(nextBoxColor);
        // rgbToArray(previousBoxColor);
        console.log('this is the previous box id '+ previousBox[0].id);
        console.log('this is the previous box color '+ previousBoxColor);
        console.log('this is the clicked box id '+ id);
        ...
        // rgbToArray(clickedColor);

        var colorChoices = new ColorStorer(clickedColor, nextBoxColor, previousBoxColor);
        console.log('this is with the constructor '+ colorChoices.rgbToArray());
        console.log(colorChoices);
        if(colorButtonChoice === 'blue'){
            if(colorArray[0][2] < 150){
